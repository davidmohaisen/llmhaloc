...
class Logger:
    ...
    def __init__(self, config=None):
        ...
        # Set up a default error log file path
        ...
        # Add a default error file handler (for ERROR and WARNING levels)
        try:
            error_file_handler = logging.FileHandler(self.error_log_path)
            error_file_handler.setLevel(logging.WARNING)  # Capture WARNING and above
            error_file_handler.setFormatter(logging.Formatter(DEFAULT_LOG_FORMAT, DEFAULT_DATE_FORMAT))
        ...
        if config:
            ...
            self.info(f"Logging initialized with default settings - Errors and warnings will be saved to: {self.error_log_path}")
    ...
    def initialize(self, config):
        ...
        error_log_file = config.get('logging', {}).get('error_log_file', 'errors.log')
        ...
        try:
            ...
            try:
                ...
                error_file_handler = logging.FileHandler(fallback_path)
