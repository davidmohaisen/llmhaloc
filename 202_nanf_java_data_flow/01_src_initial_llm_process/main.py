...
Arguments:
    ...
    --verbose                Enable verbose mode to print system and user prompts in detail
"""
...
class LLMVulProcessor:
    ...
    def __init__(self, machine_name=None, verbose=False):
        ...
        Args:
            ...
            verbose (bool, optional): Whether to print system and user prompts.
                                     Default is False.
        """
        # Load configuration
        ...
        with tqdm(total=remaining, desc=f"Processing {model_name}",
            ...
            for idx, entry in enumerate(self.data[start_idx:], start=start_idx):
                try:
                    ...
                    custom_prompt = generate_prompt(code, filename, data_flow_info)
...
def parse_arguments():
    ...
    parser.add_argument(
        '--verbose',
        action='store_true',
        help='Enable verbose mode to print system and user prompts'
    )
